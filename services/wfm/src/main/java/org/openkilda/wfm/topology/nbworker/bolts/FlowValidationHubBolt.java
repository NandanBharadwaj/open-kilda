...
import org.openkilda.wfm.topology.nbworker.commands.RemoveKeyRouterCommand;
...
public class FlowValidationHubBolt extends HubBolt {
    ...
    public void declareOutputFields(OutputFieldsDeclarer declarer) {
        ...
        declarer.declareStream(RouterBolt.INCOME_STREAM, MessageKafkaTranslator.STREAM_FIELDS);
    ...
    private class FlowValidationHubCarrierImpl implements FlowValidationHubCarrier {
        ...
        private void removeKeyFromRouterBolt(String key) {
            CommandMessage commandMessage =
                    new CommandMessage(new RemoveKeyRouterCommand(key), System.currentTimeMillis(), key);
